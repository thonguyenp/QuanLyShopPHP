...
<?php $__env->startSection('breadcrumb', 'Forgot Password'); ?>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="account-login-inner">
                        <form action="<?php echo e(route('password.email')); ?>" method="POST" id="login-form" class="ltn__form-box contact-form-box">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
<?php echo $__env->make('layouts.client_home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\QuanLyShop\resources\views/clients/auth/forgot-password.blade.php ENDPATH**/ ?>