    ...
    <div class="container py-5">
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.4s">
                <img src="<?php echo e(asset('img/about-us.jpg')); ?>" alt="About Us" class="img-fluid rounded shadow">
            </div>
        </div>
    </div>
    <!-- About Section End -->
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="border rounded p-4 bg-white shadow-sm">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            <img src="<?php echo e(asset('img/testimonial-1.jpg')); ?>" class="rounded-circle me-3" width="50" height="50" alt="Client">
                            <div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="border rounded p-4 bg-white shadow-sm">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            <img src="<?php echo e(asset('img/testimonial-2.jpg')); ?>" class="rounded-circle me-3" width="50" height="50" alt="Client">
                            <div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="border rounded p-4 bg-white shadow-sm">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            <img src="<?php echo e(asset('img/testimonial-3.jpg')); ?>" class="rounded-circle me-3" width="50" height="50" alt="Client">
                            <div>
    ...
    <div class="container py-5">
        <div class="row align-items-center">
                        ...
                        <div id="a2" class="accordion-collapse collapse show" aria-labelledby="q2" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(asset('img/video-thumbnail.jpg')); ?>" alt="Refund guide" class="img-fluid rounded me-3" style="width: 120px;">
            ...
            <div class="col-lg-6 text-center">
                <img src="<?php echo e(asset('img/questions-bg.jpg')); ?>" class="img-fluid rounded" alt="FAQ illustration">
            </div>
        </div>
    </div>
    <!-- Some Questions End -->
...
<?php echo $__env->make('layouts.client_home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\QuanLyShop\resources\views/clients/pages/about.blade.php ENDPATH**/ ?>