        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-primary px-3">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="d-flex align-items-center mt-2 me-3">
                    <a href="<?php echo e(route('wishlist.index')); ?>" class="text-white me-3">
    ...
    <!-- Navbar End -->
<?php /**PATH D:\laragon\www\QuanlyShopphp\resources\views/clients/partials/header_home.blade.php ENDPATH**/ ?>