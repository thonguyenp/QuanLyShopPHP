...
<body style="font-family: Arial, sans-serif; font-size: 15px; color: #333; line-height: 1.5; margin: 0; padding: 20px; background-color: #f4f4f4;">
    ...
    <div style="max-width: 700px; margin: 0 auto; background: #ffffff; padding: 25px; border-radius: 8px;">
        ...
        <p>Chào <strong><?php echo e($order->shippingAddress->full_name); ?></strong>,</p>
        ...
        <p style="text-align: right; font-size: 14px; color: #777;">
            Ngày tạo: <?php echo e($order->created_at->format('d/m/Y H:i')); ?>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p style="margin-top: 5px;">
                        <?php echo e($order->shippingAddress->full_name); ?><br>
                        <?php echo e($order->shippingAddress->address); ?><br>
                        <?php echo e($order->shippingAddress->city); ?><br>
                        Số điện thoại: <?php echo e($order->shippingAddress->phone); ?>
        ...
        <p style="margin-top: 5px;">
            Mã đơn hàng: <strong>#<?php echo e($order->id); ?></strong><br>
            Trạng thái: <strong><?php echo e(ucfirst($order->status)); ?></strong>
        </p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            <tr>
                ...
                <td style="text-align: right; padding: 5px; width: 150px;">
                    <?php echo e(number_format($order->total_price-25000, 0, ',', '.')); ?>₫
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: right; padding: 5px;">
                    <?php echo e(number_format(25000, 0, ',', '.')); ?>₫
                </td>
            </tr>
        ...
        <p style="text-align: center; font-size: 13px; color: #aaa; margin-top: 30px;">
            © <?php echo e(date('Y')); ?> Electro Shop — Cảm ơn bạn đã mua hàng!
        </p>
...
<?php /**PATH E:\laragon\www\QuanLyShop\resources\views/admin/emails/invoice.blade.php ENDPATH**/ ?>