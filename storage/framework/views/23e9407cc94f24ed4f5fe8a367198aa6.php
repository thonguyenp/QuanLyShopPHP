        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo e(route('admin.product.add')); ?>" id="add-product" method="POST"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\QuanlyShopphp\resources\views/admin/pages/product-add.blade.php ENDPATH**/ ?>