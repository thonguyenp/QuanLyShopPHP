            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="<?php echo e(route('products.index')); ?>" class="nav-item nav-link">Shop</a>
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="nav-item nav-link me-2">Contact</a>
...
<!-- Navbar & Hero End --><?php /**PATH E:\laragon\www\QuanLyShop\resources\views/clients/partials/header_home.blade.php ENDPATH**/ ?>