            ...
            <div class="p-5 bg-light rounded">
                <div class="row g-4">
                    ...
                    <div class="col-lg-12" style="text-align: center;">
                        ...
                        <form id="contact-form" action="<?php echo e(route('contact.sendContact')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.client_home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\QuanLyShop\resources\views/clients/pages/contact.blade.php ENDPATH**/ ?>