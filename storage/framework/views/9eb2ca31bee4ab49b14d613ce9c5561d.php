    ...
    <div class="tab-content">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <form action="<?php echo e(route('account.address.update', $item->id)); ?>" method="post" class="d-line">
                                            <?php echo csrf_field(); ?>
                                ...
                                <td>
                                    <form action="<?php echo e(route('account.address.delete', $item->id)); ?>" method="POST" class="d-line">
                                        <?php echo csrf_field(); ?>
        ...
        <!-- Chi tiết tài khoản -->
            <div class="tab-pane fade" id="liton_tab_account">
                <form action="<?php echo e(route('account.update')); ?>" method="post" id="update-account"
