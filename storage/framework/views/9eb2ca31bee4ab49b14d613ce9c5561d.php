                                ...
                                <form>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            placeholder="Nhập email" value="<?php echo e($user->email); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="inputPhone" type="tel" name="ltn_phone_number"
                                                placeholder="Nhập số điện thoại" value="<?php echo e($user->phone_number); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="inputPhone" type="tel" name="ltn_address"
                                                placeholder="Nhập số điện thoại" value="<?php echo e($user->address); ?>">
                                        </div>
                                    </div>
