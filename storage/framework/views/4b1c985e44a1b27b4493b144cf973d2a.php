                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="rounded p-4">
                        ...
                        <div>
                            ...
                            <p class="mb-2">tho.np.64cntt@ntu.edu.vn</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-4">
            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="<?php echo e(route('about')); ?>" class=""><i class="fas fa-angle-right me-2"></i> About Us</a>
    ...
    <!-- Copyright End -->
<?php /**PATH E:\laragon\www\QuanLyShop\resources\views/clients/partials/footer_home.blade.php ENDPATH**/ ?>