<div class="modal fade" id="add_to_cart_modal-{{ $product->id }}" tabindex="-1" aria-labelledby="cartModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow rounded-3">
      <div class="modal-body d-flex align-items-center">
        <!-- Product image -->
        <img src="{{ $product->image_url }}" 
             alt="{{ $product->name }}" width="70" height="70" class="rounded me-3">
