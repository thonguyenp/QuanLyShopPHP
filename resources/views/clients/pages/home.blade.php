    ...
    <div class="row g-0 justify-content-end">
            ...
            <div class="header-carousel owl-carousel bg-light py-5">
                <div class="row g-0 header-carousel-item align-items-center">
                    <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
                        <img src="{{asset('assets/clients/img/ip17.jpg')}}" class="img-fluid w-100" alt="Image">
                    </div>
                ...
                <div class="row g-0 header-carousel-item align-items-center">
                    <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
                        <img src="{{asset('assets/clients/img/zepg16.jpg')}}" class="img-fluid w-100" alt="Image">
                    </div>
                    <div class="col-xl-6 carousel-content p-4">
                        <h4 class="text-uppercase fw-bold mb-4 wow fadeInRight" data-wow-delay="0.1s"
        ...
        <div class="col-12 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay="0.1s">
            <div class="carousel-header-banner h-100">
                {{-- Tạm thời giữ lại ảnh này --}}
                <img src="{{asset('assets/clients/img/header-img2.jpg')}}" class="img-fluid w-100 h-100"
                ...
                <div class="carousel-banner">
                    <div class="carousel-banner-content text-center p-4">
                        <a href="#" class="d-block mb-2">{{$productRightBanner->category->name}}</a>
                        <a href="#" class="d-block text-white fs-3">{{$productRightBanner->name}}</a>
                        <del class="me-2 text-white fs-5">{{ number_format($productRightBanner->price + 200, 2) }}</del>
                        <span class="text-primary fs-5">{{number_format($productRightBanner->price, 2)}}</span>
                    </div>
        ...
        <div class="row g-4">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                    ...
                    <img src="{{asset('assets/clients/'.'img/offer-1.png')}}" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                    ...
                    <img src="{{asset('assets/clients/'.'img/offer-2.png')}}" class="img-fluid" alt="">
                </a>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="product-item-add border border-top-0 rounded-bottom text-center p-4 pt-0">
                                    <a href="{{ route('cart.add') }}" data-id="{{ $product->id }}"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-item-inner border rounded">
                                    {{-- Img --}}
                                    <div class="product-item-inner-item">
                                        <img src="{{ $product->image_url }}" class="img-fluid rounded-top"
                                            alt="{{ $product->name }}">
                                        <div class="product-new">New</div>
                                        <div class="product-details">
                                            <a href="{{ route('products.detail', $product->slug) }}"><i
            ...
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                <a href="#">
                    <div class="bg-primary rounded position-relative">
                        <img src="{{asset('assets/clients/' . 'img/banner-1.jpg')}}" class="img-fluid w-100 rounded" alt="">
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                <a href="#">
                    <div class="text-center bg-primary rounded position-relative">
                        <img src="{{asset('assets/clients/' . 'img/banner-2.png')}}" class="img-fluid w-100" alt="">
                        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4"
                            style="background: rgba(242, 139, 0, 0.5);">
                            <h2 class="display-2 text-secondary">GIẢM GIÁ</h2>
                            <h4 class="display-5 text-white mb-4">Lên đến 50%</h4>
                            <a href="{{ route('products.index') }}" class="btn btn-secondary rounded-pill align-self-center py-2 px-4">Mua ngay</a>
                        </div>
                    </div>
                </a>
            </div>
...
<div class="container-fluid products productList overflow-hidden">
    <div class="container products-mini py-5">
        ...
        {{-- items (tối thiểu phải có 2), 1 item lớn có 4 item nhỏ --}}
